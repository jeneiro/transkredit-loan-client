...
export default function Registration() {
  ...
  return (
    <div>
      ...
      >
        <div
          class="box box-1 col-md-4 "
          onClick={() => {
            navigate("/app/Individual-registration");
          }}
        >
          <div class="cover card shadow" style={{ cursor: "pointer" }}>
            <img className="btnimg" src={individual} alt="" />
          </div>
        ...
        >
          <div style={{ cursor: "pointer" }} class="cover card shadow">
            <img className="btnimg" src={corporative} alt="" />
          </div>
          <button className="buttonReg">
            <div></div>
          </button>
        ...
        <div
          class="box box-3 col-md-4"
          onClick={() => {
            navigate("/app/corporate-registration");
          }}
        >
          <div class="cover card shadow" style={{ cursor: "pointer" }}>
            <img className="btnimg" src={corporate} alt="" />
          </div>
          <button className="buttonReg">
            <div></div>
          </button>
      ...
      <div style={{ padding: 80, float: "right" }}>
        <h6>
          <b>
