...
<Worker  workerUrl="https://unpkg.com/pdfjs-dist@2.6.347/build/pdf.worker.min.js" >
      <div style={{ height: "720px" , marginTop: 130, padding:20, }}  className="col-md-10 offset-1">
        <Viewer fileUrl={PDF} plugins={[defaultLayoutPluginInstance]} />
      </div>
    </Worker>
    <form style={{ marginTop: 10,  float:"right", marginRight:30}} onSubmit={submitForm}>
      <div className="input-group"   > 
      <input type="checkbox" onClick={showSubmit} id="vehicle1" name="vehicle1" value="Bike" className="" />
    
  <label for="vehicle1" style={{marginLeft:"-5px"}}>...I Accept Terms & Conditions</label>
